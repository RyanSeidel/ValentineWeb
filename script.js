...
function displayResult() {
  ...
  if (answers.question1 === 'cat') {
    ...
    const catImages = ["cat.png", "cat2.png", "cat3.png", "cat4.png", "cat5.png", "cat6.png", "cat7.jpg", "cat8.jpg", "cat10.jgp", "cat11.jgp", "cat12.jpg", "cat1.jpg"]; // Update these file names as needed
